"""
Render or send an EduLage transactional e-mail for a learner.

    ./manage.py lms edulage_email welcome     <username> [--out DIR]
    ./manage.py lms edulage_email enrolment   <username> <course-v1:...> [--out DIR]
    ./manage.py lms edulage_email certificate <username> <course-v1:...> [--out DIR]
...
from edulage_platform import emails
from edulage_platform.models import SentEmail
...
class Command(BaseCommand):
    help = "Render (default) or send the EduLage welcome / enrolment / certificate e-mail."
